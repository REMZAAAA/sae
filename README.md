...
├── developpement.html              # Deuxième page thématique
...
│       └── dev.css                 # style de la page développement (controverse)
│   └── js/
...
│       └── dev_article1.png        # vignette de l'article 1 (pagge de développement de la controverse)
│       └── dev_article2.png        # 2eme vignette
│       └── dev_article3.png        # 3eme vignette
│       └── dev_article4.png        # 4eme vignette
